      ...
      <div className="mx-auto max-w-6xl px-6 py-12 md:py-20">
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
            ...
            <div className="max-w-2xl text-muted-foreground">
              ...
              <p className="mt-4 leading-relaxed">
                The prototype focused on demonstrating the basic functionality
                of this concept and providing a foundation for further
                iterations of the design and features.
              </p>
            </div>
              ...
              <ul className="divide-y divide-border border-y border-border">
                ...
                <li className="py-5">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                    The robot could be controlled using a phone through a
                ...
                <li className="py-5">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                    A servo-driven arm moved the soil sensor up and down to
                    position it for measurements.
                  </p>
                </li>
                ...
                <li className="py-5">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                    The soil moisture sensor was adjusted to differentiate
                    between different moisture levels and transmit the
                    resulting value to the connected device.
                  </p>
                </li>
                ...
                <li className="py-5">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                    Three servo motors provided flexibility for controlling
                    the robot arm.
                  </p>
                </li>
        ...
        <section className="mt-24">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 leading-relaxed text-muted-foreground">
              The prototype combined electronic components with custom
              3D-printed parts designed for the robot arm.
            </p>
          </div>
        ...
        <section className="mt-24">
          ...
          <p className="mt-5 max-w-2xl leading-relaxed text-muted-foreground">
            ...
            control, soil moisture sensing and an articulated arm into one
